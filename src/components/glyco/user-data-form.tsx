  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center gap-4">
        ...
        <div>
            <CardTitle>Your Biodata</CardTitle>
            <CardDescription>This information helps the AI provide personalized advice. It is not stored anywhere.</CardDescription>
        </div>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="insulinBrand">Insulin Brand</Label>
